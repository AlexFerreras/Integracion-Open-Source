            ...
            <Grid container spacing={3} style={mt15}>
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  helperText={
                    errors.indiceAcumulado && errors.indiceAcumulado.message
                  }
                  inputRef={register({
                    required: "El índice acumulado es obligatoria",
                    pattern: {
                      value: /([1-4])/,
                      message: "Solo se admiten numeros del 1 al 4",
                    },
                  })}
                  fullWidth
                  type="text"
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  helperText={
                    errors.indiceCuatrimestral &&
                    errors.indiceCuatrimestral.message
                  }
                  inputRef={register({
                    required: "El índice cuatrimestral es obligatoria",
            ...
            <Table className={classes.table}>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="center">
                    <strong>INDICE ACADEMICO </strong>{" "}
                  </TableCell>
                  <TableCell align="center">
                    <strong>INDICE CUATRIMESTRAL </strong>{" "}
                  </TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
